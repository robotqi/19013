...
/**
 ...
 @version 1.1 05/7/2014
 @assignment.number A190-13
 ...
 */
public class A19013 extends JDialog
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        populateGradesButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                String strFile = "C:\\Users\\Chelsea\\A19013\\Data\\grades.txt";
        ...
        populateRosterButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                String fileDir = "C:\\Users\\Chelsea\\A19013\\Data\\roster.txt";
        ...
        createReportButton.addActionListener(new ActionListener()
        {
            ...
            {
                DBUpdt db = new DBUpdt();
                String saveFileDir = "C:\\Users\\Chelsea\\A19013\\Data\\semester.txt";
                try
                {
                    PrintWriter outputFile = new PrintWriter(saveFileDir);
                ...
                db.openConnection("Gradebook");
                db.query("SELECT ROSTER.*, GRADES.* FROM ROSTER INNER JOIN GRADES ON ROSTER.stuid=GRADES.stuid ORDER BY " +
                        "lastname, firstname");

                while(db.moreRecords())
                {
                    strLastName = db.getField("lastname");
                    strFirstName = db.getField("firstname");
                    strStudentId = db.getField("stuid");
                    strEmail = db.getField("email");
                    numQuiz = getQuizTotal(strStudentId);
                    numAstTotal = getAsgnTotal(strStudentId);
                    numTotal = numQuiz + numAstTotal;
                    strLetter = getLetterGrade(numTotal);

                    outputFile.println(strLastName + "; " + strFirstName + "; " + strStudentId + "; " + strEmail + "; " +
                            Float.toString(numQuiz) + "; " + Float.toString(numAstTotal) + "; " +
                            Float.toString(numTotal) + "; " + strLetter);
                }
                outputFile.close();
